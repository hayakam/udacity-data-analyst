...
missmap(loandata_completed, main = "Missing values vs observed")
...
dim(loandata_completed)[1]/2

### test with smaller data first, as full data seems to be too heavy for mac book air

train <- loandata_completed[1:1000,]
test <- loandata_completed[1001:2000,]
